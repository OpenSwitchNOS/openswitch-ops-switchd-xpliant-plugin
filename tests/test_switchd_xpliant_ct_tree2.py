...
class xpSimTest( OpsVsiTest ):
    ...
    def net_provision(self):
        ...
        s1.ovscmd("/usr/bin/ovs-vsctl add-vlan bridge_normal 300 admin=up")
        s1.ovscmd("/usr/bin/ovs-vsctl add-port bridge_normal 1 vlan_mode=trunk trunks=200,300")
        s1.ovscmd("/usr/bin/ovs-vsctl add-port bridge_normal 2 vlan_mode=trunk trunks=200,300")
        ...
        s2.ovscmd("/usr/bin/ovs-vsctl add-vlan bridge_normal 200 admin=up")
        s2.ovscmd("/usr/bin/ovs-vsctl add-vlan bridge_normal 300 admin=up")
        s2.ovscmd("/usr/bin/ovs-vsctl add-port bridge_normal 1 vlan_mode=trunk trunks=200,300")
        s2.ovscmd("/usr/bin/ovs-vsctl add-port bridge_normal 2 vlan_mode=access tag=200")
        s2.ovscmd("/usr/bin/ovs-vsctl add-port bridge_normal 3 vlan_mode=access tag=300")
        ...
        s2.ovscmd("/usr/bin/ovs-vsctl set interface 4 user_config:admin=up")
        s2.ovscmd("/usr/bin/ovs-vsctl set interface 5 user_config:admin=up")
        info("\n")

        info("[s3-1] trunk 200,300\n")
        info("[s3-2] access 200\n")
        info("[s3-3] access 300\n")
        s3.ovscmd("/usr/bin/ovs-vsctl add-vlan bridge_normal 200 admin=up")
        s3.ovscmd("/usr/bin/ovs-vsctl add-vlan bridge_normal 300 admin=up")
        s3.ovscmd("/usr/bin/ovs-vsctl add-port bridge_normal 1 vlan_mode=trunk trunks=200,300")
        s3.ovscmd("/usr/bin/ovs-vsctl add-port bridge_normal 2 vlan_mode=access tag=200")
        s3.ovscmd("/usr/bin/ovs-vsctl add-port bridge_normal 3 vlan_mode=access tag=300")
        s3.ovscmd("/usr/bin/ovs-vsctl set interface 1 user_config:admin=up")
        s3.ovscmd("/usr/bin/ovs-vsctl set interface 2 user_config:admin=up")
        s3.ovscmd("/usr/bin/ovs-vsctl set interface 3 user_config:admin=up")
        info("\n")
